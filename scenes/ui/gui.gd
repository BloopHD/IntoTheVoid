...
@onready var health_bar: ProgressBar = $MarginContainer/Rows/TopRow/TopLeft/HealthBarMargin/HealthBar
@onready var shield_bar: ProgressBar = $MarginContainer/Rows/TopRow/TopLeft/ShieldBarMargin/ShieldBar
...
func set_new_shield_value(new_shield: int) -> void:
